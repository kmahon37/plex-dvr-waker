...
- Windows .NET Runtime 8.0 ([download from Microsoft](https://dotnet.microsoft.com/download/dotnet-core/8.0))
...
## Installation
1. Download and install the latest Windows .NET Runtime 8.0
